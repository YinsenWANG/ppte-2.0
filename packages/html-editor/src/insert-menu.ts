...
`; document.head.append(css);
    ...
    const attach=()=>frame?.contentDocument?.addEventListener('pointerdown',()=>close(false));frame?.addEventListener('load',attach);attach();

...
function validateOperationShape(operation: Record<string, unknown>, index: number, issues: ValidationIssue[]) {
  ...
  switch (kind) {
    ...
    case 'group.rotate': requireString('groupId'); requireFiniteNumber('rotationDeg'); break
    ...
    case 'fact.delete': requireString('factId'); if (operation.removeEmptyCollection !== undefined && typeof operation.removeEmptyCollection !== 'boolean') issues.push(error('SCHEMA_INVALID', 'fact.delete.removeEmptyCollection must be boolean.', `${path}/removeEmptyCollection`)); break
    ...
    case 'source.delete': requireString('sourceId'); if (operation.removeEmptyCollection !== undefined && typeof operation.removeEmptyCollection !== 'boolean') issues.push(error('SCHEMA_INVALID', 'source.delete.removeEmptyCollection must be boolean.', `${path}/removeEmptyCollection`)); break
